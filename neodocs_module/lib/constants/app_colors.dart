...
class AppColors {
  ...
  static Color newPrimaryColor = Color(0XFF000749);
  ...
  static BoxDecoration brightSecondaryDecoration = BoxDecoration(
    gradient: LinearGradient(
      colors: [Color(0XFFF2F8FF), Color(0XFFD0D9E5).withOpacity(0.87)],
    ),
  );
  ...
  static BoxDecoration brightOverlappingCardDecoration = BoxDecoration(
    gradient: LinearGradient(
      colors: [
        Color(0XFFEFEEFD).withOpacity(0.8),
  ...
  static BoxDecoration brightCardsDecoration = BoxDecoration(
    boxShadow: [
      BoxShadow(
        color: Color(0XFF737171).withOpacity(0.28),
        offset: Offset(13, 1),
        blurRadius: 87,
        spreadRadius: 0,
      ),

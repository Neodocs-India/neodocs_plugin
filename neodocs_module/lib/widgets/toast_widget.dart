...
class Toast {
  ...
  void showToast(text) {
    BotToast.showText(
        text: text, contentColor: backgroundColor);
  }
  ...
  void showToastDialog(text) {
    BotToast.showText(
        ...
        textStyle: textStyle ??  Theme.of(context).textTheme.bodyMedium!.copyWith(color: AppColors.white),
        text: text, contentColor: AppColors.primaryColor);
  }

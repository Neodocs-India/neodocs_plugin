                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () async {
                          ...
                          Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (_)=> CaptureScreen(cameras: cameras,startTime: DateTime.fromMicrosecondsSinceEpoch(widget.map["startTime"] * 1000),user: widget.map,)));
                        },
                        child: Padding(
